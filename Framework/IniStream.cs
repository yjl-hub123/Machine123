...
namespace Machine
{
    ...
    public class IniStream
    {
        ...
        public bool OpenRead(string filePath)
        {
            ...
            {
                Trace.WriteLine(string.Format("IniStream.OpenFile({0}) error: {1}", filePath, ex.Message));
            }
            return false;
        }
        ...
        public bool DeleteFile()
        {
            ...
            {
                Trace.WriteLine(string.Format("IniStream.DeleteFile() error: {0}", ex.Message));
            }
            return false;
        }
        ...
        public void ClearData()
        {
            ...
            {
                Trace.WriteLine(string.Format("IniStream.ClearData() error: {0}", ex.Message));
            }
        }
        ...
        private bool FileToData(string buffer)
        {
            ...
            {
                Trace.WriteLine(string.Format("IniStream.FileToData() error: {0}", ex.Message));
            }
            return false;
        }
        ...
        public bool DataToFile()
        {
            ...
            {
                Trace.WriteLine(string.Format("IniStream.DataToFile() error: {0}", ex.Message));
            }
            return false;
        }
