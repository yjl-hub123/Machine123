...
namespace Machine
{
    public class MachineCtrl : ControlInterface
    {
                ...
                case MESINDEX.MesJigdataCollect:
                    {
                        ...
                        strColHead = "Site,User,Operation,OperationRevision,Resource,ModeProcessSfc,DCGroup,DCGroupRevision,ActivityId,ncGroup,Mode,BKOVENNO,混合型,BKANDHMDTY,BKCADHMDTY,BKVBVPMIN,BKVBVPMAX,BKTIME,BKSTARTTIME,BKOVERTIME,BKVBTIME,BKVACM,PROCESSLOT,YRSJ,BKMINTMPVACM ,BKMAXTMPVACM,PIS,BKPISGG,BKZXPIS,BXPISSHLGG,BKGCPIS,干燥炉资源号,干燥炉编号(ID),炉层(A-B-C-D-E),开始调用时间,数据上传成功时间,夹具条码,电芯条码,耗时(ms),返回代码(Code),Message,阴极,阳极,电芯位置信息,呼吸次数";
                        break;  
                    }
        ...
        public bool MesWaterCollect(int nDryOvenID, string strJigCode, string[] strValue, string[] strValue2, string[] strTimeValuestring, string srBkOvenNo, ref int nCode, ref string strMsg, ref string[] mesParam,bool[] bValues)
        {
            ...
            hotPressParameData[21].value = strValue2[8];
            ...
            hotPressParameData[22].value = strValue2[9];
            ...
            hotPressParameData[23].value = strValue2[10];
            ...
            hotPressParameData[24].value = strValue2[11];
            ...
            mesParam[30] = strValue2[8];//bkai   PIS值 //PIS值 
            mesParam[31] = strValue2[9];  //BKPISGG // strValue2[10];//bkai   //过程规格值
            mesParam[32] = strValue2[10]; // BKZXPIS  strValue2[11];//bkai   //最小pis值
            mesParam[33] = strValue2[11];  //BXPISSHLGG   //水含量规格值 
